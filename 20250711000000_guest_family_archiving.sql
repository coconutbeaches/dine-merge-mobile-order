-- Migration: Guest Family Archiving
-- This migration creates the guest_family_archives table and updates customer functions
-- to support archiving guest families without mutating historical order data.
